...
from goals.category.schemas import GoalCategoryDetectRequest, GoalCategoryDetectResponse
from goals.goal.schemas import GoalCreate
from goals.category.service import GoalCategoryService
