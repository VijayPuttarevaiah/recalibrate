...
class TestCreateChatSession:
    ...
    @patch("chat.services.chat_service._call_chat_llm", return_value="AI response here.")
    @patch("chat.services.chat_service._check_rate_limit", return_value=True)
    ...
    @patch("chat.services.chat_service._check_rate_limit", return_value=False)
    ...
    @patch("chat.services.chat_service._call_chat_llm", return_value="Response")
    @patch("chat.services.chat_service._check_rate_limit", return_value=True)
...
class TestSendMessage:
    ...
    @patch("chat.services.chat_service._call_chat_llm", return_value="Follow-up response.")
    @patch("chat.services.chat_service._check_rate_limit", return_value=True)
...
class TestExplainTask:
    ...
    @patch("chat.services.chat_service._call_chat_llm", return_value="This task means you need to write a compelling SOP.")
    ...
    @patch("chat.services.chat_service._call_chat_llm")
...
class TestGetSuggestedQuestions:
    ...
    @patch("chat.services.chat_service._generate_suggestions", return_value=["Q1", "Q2", "Q3"])
