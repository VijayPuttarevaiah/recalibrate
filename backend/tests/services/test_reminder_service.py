...
Covers:
  - check_upcoming_deadlines: task filtering, notification dispatch,
    user-not-found guard, DB always closed, exception safety
"""
import pytest
...
class TestCheckUpcomingDeadlines:
    ...
    def test_creates_notification_for_each_task(self, mock_create, mock_session):
        mock_db = MagicMock()
    ...
    @patch("services.reminder_service.SessionLocal")
    @patch("services.reminder_service.create_notification")
    def test_notification_uses_correct_title(self, mock_create, mock_session):
        mock_db = MagicMock()
        mock_session.return_value = mock_db

        mock_db.query.return_value.filter.return_value.all.return_value = [
            make_task(1, 1, "My Task")
        ]
    ...
    @patch("services.reminder_service.SessionLocal")
    @patch("services.reminder_service.create_notification")
    def test_send_mail_is_true(self, mock_create, mock_session):
        mock_db = MagicMock()
        mock_session.return_value = mock_db
    ...
    @patch("services.reminder_service.SessionLocal")
    @patch("services.reminder_service.create_notification")
    def test_correct_email_passed_to_notification(self, mock_create, mock_session):
        mock_db = MagicMock()
        mock_session.return_value = mock_db
    ...
    @patch("services.reminder_service.SessionLocal")
    @patch("services.reminder_service.create_notification")
    def test_db_closed_after_success(self, mock_create, mock_session):
        mock_db = MagicMock()
        mock_session.return_value = mock_db
        mock_db.query.return_value.filter.return_value.all.return_value = []
    ...
    @patch("services.reminder_service.SessionLocal")
    @patch("services.reminder_service.create_notification")
    def test_db_closed_even_when_exception_raised(self, mock_create, mock_session):
        mock_db = MagicMock()
        mock_session.return_value = mock_db
