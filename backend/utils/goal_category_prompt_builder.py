...
- "Join a university in Canada" + note: "no knowledge, haven't consulted anyone" -> career_and_learning, is_sufficient: true (binary: get accepted; lack of knowledge is fine)
