...
from schemas.goal_schemas import GoalCreate, GoalResponse, GoalWithTasksResponse
from services.goal_service import create_goal_with_tasks, get_user_goals, get_goal_tasks
...
def get_goal_tasks_api(
    ...
    return get_goal_tasks(db, current_user["user_id"], goal_id)